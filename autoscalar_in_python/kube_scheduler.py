...
api_token = "149aa03f-c0e4-47c5-80a5-7c25ef8bc09b"

sdclient = SdcClient(api_token)
...
def get_request_time(hostname):
    ...
    print metricdata[1].get('data')[0].get('d')[0]
...
def main():
    w = watch.Watch()
    for event in w.stream(v1.list_namespaced_pod, "custom-scheduler"):
